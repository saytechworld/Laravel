                    ...
                    if(!empty($readnotification)){
                        ...
                        if ($notification->type == 3) {
                            ...
                            if ($input['action'] == 1) {
                                ...
                                $team_notification_message = auth()->user()->name.' have accepted '.$team->title.' team request ';
                            } else {
                                $team_notification_message = auth()->user()->name.' have rejected '.$team->title.' team request ';
                            }
                            ...
                            if ($input['action'] == 1) {
                                $event_notification_message = auth()->user()->name.' have accepted '.$event->title.' event request ';
                            } else {
                                $event_notification_message = auth()->user()->name.' have rejected '.$event->title.' event request ';
                            }
