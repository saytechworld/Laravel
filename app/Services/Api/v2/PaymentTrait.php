...
trait PaymentTrait
{
    ...
    public function payout(Request $request) {
        ...
        try {
            ...
            if ($input['amount'] < config('staging_live_config.MINIMUM_PAYMENT') || $input['amount'] > auth()->user()->remaining_balance) {
                throw new Exception("Amount should be between ".config('staging_live_config.MINIMUM_PAYMENT')." and ".auth()->user()->remaining_balance.".", 1);
            }
