...
trait PhotoUploadTrait
{
    ...
    public function updatePhoto(Request $request) {
        ...
        try {
            ...
            $video = Video::with('video_tags:id,title')->selectRaw('id,title,description,privacy,user_id,file_name,user_folder_id')->where(['id' => $input['video_id'], 'user_id' => $user->id , 'file_type' => 2])->first();
