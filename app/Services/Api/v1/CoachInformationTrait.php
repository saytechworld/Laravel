...
trait CoachInformationTrait
{
    ...
    public function getCoachVideo(Request $request) {
        try {
            ...
            $videos = Video::with('video_tags:id,title')->selectRaw('id ,title, description,privacy,user_id,file_name,thumbnail,file_type,user_folder_id')->where(['user_id' => $input['id'], 'file_type' => 1])->paginate(25, ['*'], 'page', $page);
