    ...
    public function orderList(Request $request)
    {
        try {
            ...
            $orders = Order::with('plan:id,title')
                ...
                ->where(['user_id' => $user->id])->paginate(25,['*'],'page', $page);
        ...
        try {
            ...
            if ($session_requests->count() > 0) {
                ...
                $session_requests->map(function ($session_request) {
                   $session_request->makeHidden(['chat_id','session_platform_fees','session_price_vat','total_session_price','parsing_session_price']);
