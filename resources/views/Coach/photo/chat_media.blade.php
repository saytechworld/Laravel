...
@section('title', 'Messenger Photos')
@section('parentPageTitle', 'Messenger Photos')
@section('content')
<div class="row clearfix">
        <div class="col-lg-12">
            <div class="card messenger_video_sec">
                <div class="header">
                    <h2>Messenger Photos</h2>
                </div>
                <div class="body">
                    <div class="f-frm-sec search_video_frm">
                        <ul class="cmn-ul-list contact_folder_search_sec">
                            {!! Form::open(array('url' => route('coach.photo.chatmedia'),'method' => 'GET', 'files' => "true")) !!}
                                    ...
                                    <div class="card">
                                        <div class="file">
                                                ...
                                                <div class="image video-bx">
                                                    <img class="image-click" src="{!!  env('AWS_URL').'messages/'.$chat_video_val->message !!}">
                                                </div>
                                                <div class="file-name">
